...
def main(args=None):
    ...
    yaml_data.append = get_yaml(f"/home/ubuntu/Turtlebot_Controller/src/agent_control/config/goals/agent_goal({num}).yaml")
    goal = yaml_data[f"goal{script_args.index}"]
    ...
    my_robot = Path_Test(int(script_args.index), np.array(neighbor), sim=script_args.sim, 
