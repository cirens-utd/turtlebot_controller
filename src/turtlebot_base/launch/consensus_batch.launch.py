...
def launch_dynamic_nodes(context: LaunchContext, *args, **kwargs):
    ...
    #     sim_path_config = os.path.join(pkg_path,'config','consensus_sim_config.yaml')
...
def generate_launch_description():
    ...
    yaml_load_arg = DeclareLaunchArgument(
        'yaml_load',
        default_value='True',
        description="Load from config/consensus_sim_config.yaml or load with Launch arguments"
    )
