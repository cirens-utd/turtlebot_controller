...
: ${AMENT_CURRENT_PREFIX:="/media/sf_MacShare/turtlebot_simulator/install/turtlebot_base"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/turtlebot_base/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/turtlebot_base/environment/path.sh"
